...
public class LibgdxItemWheelBindingSetSimple implements LibgdxItemWheelBindingSet {
	...
	private final LibgdxActivityProvider provider;
	Activity addedLast = null;
	private int reoccurrenceCycleSize;

	@Override
	public LibgdxActivityProvider getProvider() {
		return provider;
	}
	...
	public LibgdxItemWheelBindingSetSimple(int initialValue, int itemWheelSize,
										   LibgdxActivityProvider provider, int reoccurrenceCycleSize) {
