...
public class LibgdxGraphics implements Graphics {
	...
	public LibgdxGraphics(AssetManager assets, Bitmap frameBuffer) {
		this.assets = assets;
	...
	public Paint createPaint(PaintBuilder builder) {
		...
		paint.setColor(LibgdxGraphics.convertColor(builder.getColor()));
	...
	public Paint getPaintWhite() {
		return new LibgdxPaint(labelPaint);
	}


	@Override
	public Paint getPaintGray() {
		return new LibgdxPaint(gray);
	}
	...
	public Image newImage(String fileName, ImageFormat format) {
		...
		return new LibgdxImage(bitmap, format);
	}
	...
	public Image getTempImage() {
		...
		if(tmpBitmap != null) {
			return new LibgdxImage(tmpBitmap, format);
	...
	public void drawImage(Image Image, int x, int y, int srcX, int srcY, int srcWidth, int srcHeight) {
		...
		if (tmpCanvas == null) {
			canvas.drawBitmap(((LibgdxImage) Image).bitmap, srcRect, dstRect, null);
		}
		else {
			...
			tmpCanvas.drawBitmap(((LibgdxImage) Image).bitmap, srcRect, tmpDstRect, null);
		}
	}
	...
	public void drawImage(Image image, int x, int y, boolean nonTmp) {
		if (tmpCanvas == null || nonTmp) {
			canvas.drawBitmap(((LibgdxImage) image).bitmap, x, y, null);
		}
		else {
			tmpCanvas.drawBitmap(((LibgdxImage) image).bitmap, x - tmpCanvasX, y - tmpCanvasY, null);
		}
	}
