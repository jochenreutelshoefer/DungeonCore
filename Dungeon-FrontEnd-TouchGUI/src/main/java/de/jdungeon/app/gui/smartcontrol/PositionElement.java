...
public class PositionElement extends AnimatedSmartControlElement {
	...
	public PositionElement(JDPoint position, JDDimension dimension, final GUIElement parent, RoomInfoEntity action, final Color color, RoomInfoEntity clickableObject, ActionAssembler actionAssembler) {
		this(position, dimension, parent, action, color, clickableObject, actionAssembler, -1);
	}

	public PositionElement(JDPoint position, JDDimension dimension, final GUIElement parent, RoomInfoEntity action, final Color color, RoomInfoEntity clickableObject, ActionAssembler actionAssembler, int positionIndex) {
