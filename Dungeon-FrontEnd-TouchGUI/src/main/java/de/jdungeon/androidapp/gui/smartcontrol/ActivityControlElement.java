...
public class ActivityControlElement extends AnimatedSmartControlElement {
	...
	public ActivityControlElement(JDPoint position, final JDDimension dimension, GUIElement parent, RouteInstruction.Direction direction, FigureInfo figure, GUIControl guiControl, ExecutableActivity activity, final Image skillImage) {
