...
public class ItemPool {
	...
	private static String[] spells = { "heal",
			"escape", "bonebreaker", "fireball", "spy", "key_locator", "isolation", "escapeRoute", "fir" };
	...
	private static int[] spell_values = { heal,
			escape, bonebreaker, fireball, spy, key_locator, isolation, escapeRoute };
	...
	public static Item getLowerItem(int value, double quotient) {
		...
		////System.out.println("making lower de.jdungeon.item!"+" "+quotient);
		int sum = summieren(p);
