...
import de.jdungeon.spell.Escape;
import de.jdungeon.spell.EscapeRoute;
...
public class Character implements Serializable {
    ...
    public Character(Character character, Figure figure) {
        this(character.getName(),
                (int) character.health.getBasic(),
                (int) character.getStrength().getBasic(),
                (int) character.getDexterity().getBasic(),
                (int) character.getPsycho().getBasic(),
                (int) character.getDust().getBasic(),
                character.getDustReg().getBasic(), figure);
    }
