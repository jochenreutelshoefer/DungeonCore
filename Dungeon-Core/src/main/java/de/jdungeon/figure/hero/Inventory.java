...
public class Inventory implements Serializable {
    ...
    public Inventory(int weaponsI, int armorsI, int helmetsI, int shieldsI, Figure f) {
        owner = f;
    ...
    public static Inventory copy(Inventory inventory, Figure figure) {

        Inventory copy = new Inventory();
        copy.setOwner(figure);
        ...
        for (Armor armor : armors) {
            if (armor != null) {
                copy.take_armor1(armor.copy());
            }
        }

        Helmet[] helmets = inventory.getHelmets();
        for (Helmet armor : helmets) {
            if (armor != null) {
                copy.take_helmet1(armor.copy());
            }
        }

        Weapon[] weapons = inventory.getWeapons();
        for (Weapon armor : weapons) {
            if (armor != null) {
                copy.take_weapon1(armor.copy());
            }
        }

        Shield[] shields = inventory.getShields();
        for (Shield armor : shields) {
            if (armor != null) {
                copy.take_shield1(armor.copy());
            }
        }
    ...
    private void setOwner(Figure figure) {
        this.owner = figure;
    }
     ...
     *
     * @param w a <code>weapon</code> value
     ...
     *
     * @param a an <code>an_armor</code> value
     * @return a <code>boolean</code> value
     */
     ...
     *
     * @param h a <code>helmet</code> value
     * @return a <code>boolean</code> value
     */
