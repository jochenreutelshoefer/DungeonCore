...
//		runeFinderShrine4Room.setShrine(rfs4, true);
		...
		DefaultHall otherHall = makeHall(0, 0, 3000, 70, 0, 0, h1, 0, "other",6);
...
//					}
	...
	private List<Key> fillHallWithRQ(DefaultHall halle) {
		//System.out.println();
	...
	private RoomQuest trySetRoomQuest(int size, DefaultHall halle) {
