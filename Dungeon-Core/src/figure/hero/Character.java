...
public class Character {
	...
	public Character(String name, int HealthVal, int StrengthVal,
		...
		attributes.put(new Integer(Attribute.HEALTH),health);

		this.strength = new Attribute((Attribute.STRENGTH), StrengthVal);
		attributes.put(new Integer(Attribute.STRENGTH),strength);
		
		this.healthReg = new DerivedAttribute(Attribute.HEALTHREG, strength,
				DerivedAttribute.FORMULAR_KEY_8TH);
		attributes.put(new Integer(Attribute.HEALTHREG),healthReg);

		this.dexterity = new Attribute(Attribute.DEXTERITY, DexterityVal);
		attributes.put(new Integer(Attribute.DEXTERITY),dexterity);

		this.psycho = new Attribute(Attribute.PSYCHO, PsychoVal);
		attributes.put(new Integer(Attribute.PSYCHO),psycho);

		this.axe = new Attribute(Attribute.AXE, Axe);
		attributes.put(new Integer(Attribute.AXE),axe);

		this.lance = new Attribute(Attribute.LANCE, Lance);
		attributes.put(new Integer(Attribute.LANCE),lance);

		this.sword = new Attribute(Attribute.SWORD, Sword);
		attributes.put(new Integer(Attribute.SWORD),sword);

		this.club = new Attribute(Attribute.CLUB, Club);
		attributes.put(new Integer(Attribute.CLUB),club);

		this.wolfknife = new Attribute(Attribute.WOLFKNIFE, Wolfknife);
		attributes.put(new Integer(Attribute.WOLFKNIFE),wolfknife);

		this.natureKnowledge = new Attribute(Attribute.NATURE_KNOWLEDGE,
				nature);
		attributes.put(new Integer(Attribute.NATURE_KNOWLEDGE),natureKnowledge);

		this.creatureKnowledge = new Attribute(Attribute.CREATURE_KNOWLEDGE,
				creature);
		attributes.put(new Integer(Attribute.CREATURE_KNOWLEDGE),creatureKnowledge);

		this.undeadKnowledge = new Attribute((Attribute.UNDEAD_KNOWLEDGE),
				undead);
		attributes.put(new Integer(Attribute.UNDEAD_KNOWLEDGE),undeadKnowledge);

		this.scout = new Attribute(Attribute.SCOUT, scout);
		attributes.put(new Integer(Attribute.SCOUT),this.scout);
		

		this.dust = new Attribute(Attribute.DUST, dust);
		attributes.put(new Integer(Attribute.DUST),this.dust);
		
		this.dustReg = new Attribute(Attribute.DUSTREG, dustReg);
		attributes.put(new Integer(Attribute.DUSTREG),this.dustReg);

		this.threat = new Attribute(Attribute.THREAT,
				(strength.getBasic() + psycho.getBasic()) / 5);
		attributes.put(new Integer(Attribute.THREAT),threat);
...
//			return strength;
//		} else if (a == Attribute.DEXTERITY) {
//			return dexterity;
//		} else if (a == Attribute.PSYCHO) {
//			return psycho;
//		} else if (a == Attribute.AXE) {
//			return axe;
//		} else if (a == Attribute.CLUB) {
//			return club;
//		} else if (a == Attribute.LANCE) {
//			return lance;
//		} else if (a == Attribute.SWORD) {
//			return sword;
//		} else if (a == Attribute.WOLFKNIFE) {
//			return wolfknife;
//		} else if (a == Attribute.NATURE_KNOWLEDGE) {
//			return natureKnowledge;
//		} else if (a == Attribute.CREATURE_KNOWLEDGE) {
//			return creatureKnowledge;
//		} else if (a == Attribute.UNDEAD_KNOWLEDGE) {
...
//			return health;
//		} else if (a == Attribute.DUST) {
//			return dust;
//		} else if (a == Attribute.DUSTREG) {
//			return dustReg;
//		} else if (a == Attribute.HEALTHREG) {
//			return healthReg;
//
//		} else
//			return (new Attribute(-1, 0));
//	}
	...
	// //System.out.println("Hero modFightAP:"+v);
	// fightAP = fightAP - v;
	// }
	/**
	...
	// public void decActionPoints(int a) {
	// actionPoints = actionPoints - a;
	// if (actionPoints < 0) {
	// //System.out.println("ActionPoints Error!");
	// }
	// }

	/**
	 * Describe <code>incActionPoints</code> method here.
	 * 
	 * @return an <code>void</code> value
	 */
	// public void incActionPoints(int a) {
	// actionPoints = actionPoints + a;
	//
	// }
	...
	/**
	 * Returns the actionPoints.
	 * 
	 * @return int
	 * 
	 * @uml.property name="actionPoints"
	 */
	...
	/**
	 * Returns the creature_Knowledge.
	 * 
	 * @return attribute
	 * 
	 * @uml.property name="creature_Knowledge"
	 */
	...
	public Attribute getHealth() {
		// System.out.println("Char returns Health");
		return health;
	}
	 ...
	 * @return LinkedList
	 * 
	 * @uml.property name="modifications"
	 */
	...
	/**
	 * Returns the nature_Knowledge.
	 * 
	 * @return attribute
	 * 
	 * @uml.property name="nature_Knowledge"
	 */
	...
	/**
	 * Returns the selfLevel.
	 * 
	 * @return int
	 * 
	 * @uml.property name="selfLevel"
	 */
	...
	/**
	 * Returns the weaponExp.
	 * 
	 * @return int[]
	 * 
	 * @uml.property name="weaponExp"
	 */
