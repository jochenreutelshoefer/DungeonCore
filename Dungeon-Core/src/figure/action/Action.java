...
public abstract class Action {
	 ...
	 * 
	 * @param fighterIndex
	 *            Identifikationsindex der Angreifer-Figur
	 * @param target
	 *            Gegner
	 * @return Angriffssaktion
	 */
	public static AttackAction makeActionAttack(
	/* int fighterIndex, */int target) {
		...
		// game.newStatement("Hier gibts grad nichts zu k�mpfen",1);
		// }
		// }
		// return null;
	}
	...
	public static MoveAction makeActionMove(int fighterIndex, int dir) {
		...
		// if(game.getFight() == null || game.getFight().getFightRoom() !=
		// f.getRoom()) {
		//
	...
	public static UseItemAction makeActionUseItem(
