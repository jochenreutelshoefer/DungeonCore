...
public class FileListPreprocessor {
    ...
    private static final String ASSET_FOLDER = "Libgdx-Dungeon-Basic/src/main/resources/assets/"; //de.jdungeon.animation/
    ...
    private static void createFilelistFile(File assetContentFolder) throws IOException {
        ...
        Files.write(fileListFile.toPath(), buffy.toString().getBytes(Charset.defaultCharset()), StandardOpenOption.CREATE);
